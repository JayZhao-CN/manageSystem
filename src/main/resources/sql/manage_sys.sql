...
CREATE TABLE `sys_color` (
  ...
  `c_company` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0',
  PRIMARY KEY (`c_id`),
...
CREATE TABLE `sys_company` (
  ...
  `co_code` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公司编号',
  `co_state` int NOT NULL COMMENT '公司状态',
  PRIMARY KEY (`co_id`),
  UNIQUE KEY `co_name` (`co_name`),
  UNIQUE KEY `co_code` (`co_code`)
...
CREATE TABLE `sys_ext_propties_column` (
  ...
  `ext_propties_code` varchar(64) DEFAULT NULL COMMENT '扩展属性code',
  `ext_column_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '该扩展属性的名称',
  `ext_column_img` varchar(255) DEFAULT NULL COMMENT '该扩展属性的图片地址',
  `ext_column_color` varchar(255) DEFAULT NULL COMMENT '该扩展属性的颜色值',
  `ext_column_code` varchar(255) DEFAULT NULL COMMENT '该条数据的唯一标识符',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sys_process` (
  ...
  `prc_name` varchar(255) NOT NULL COMMENT '工序名称',
  `prc_company` varchar(15) NOT NULL DEFAULT '0' COMMENT '所属公司',
  PRIMARY KEY (`prc_id`),
  UNIQUE KEY `prc_code` (`prc_code`)
...
-- ----------------------------
-- Table structure for sys_process_remark
-- ----------------------------
DROP TABLE IF EXISTS `sys_process_remark`;
CREATE TABLE `sys_process_remark` (
  `prr_id` int NOT NULL AUTO_INCREMENT,
  `prr_company` varchar(7) NOT NULL,
  `prr_x` varchar(5) NOT NULL,
  `prr_remark` varchar(255) NOT NULL,
  PRIMARY KEY (`prr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- ----------------------------
-- Records of sys_process_remark
-- ----------------------------
...
CREATE TABLE `sys_product` (
  ...
  `pr_remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`pr_id`),
...
CREATE TABLE `sys_product_process` (
  `id` int NOT NULL,
  `product_type_code` varchar(15) DEFAULT NULL COMMENT '产品类型code',
  `process_code` varchar(15) DEFAULT NULL COMMENT '工序code',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `sys_product_propties` (
  ...
  `propties_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '属性唯一标识符',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `sys_propties` (
  `id` int NOT NULL AUTO_INCREMENT,
  `propties_name` varchar(64) DEFAULT NULL COMMENT '属性名',
  `propties_company_code` varchar(15) DEFAULT NULL COMMENT '所属公司',
  `propties_code` varchar(64) DEFAULT NULL COMMENT '属性唯一标识符',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
...
-- ----------------------------
INSERT INTO `sys_propties` VALUES ('1', '材质', '2325', 'ad-47a47745-ad');
...
CREATE TABLE `sys_table_info` (
  ...
  `ti_table` varchar(64) NOT NULL,
  `ti_name` varchar(255) NOT NULL,
  `ti_lable` varchar(64) DEFAULT NULL COMMENT '通俗叫法',
  PRIMARY KEY (`ti_id`)
...
CREATE TABLE `sys_url_auth` (
  ...
  `ua_url` varchar(255) NOT NULL,
  `ua_auth` varchar(255) NOT NULL,
  PRIMARY KEY (`ua_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `sys_user` (
  ...
  `u_phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系方式',
  `u_company` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公司编号',
  `u_position` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '职位',
  `u_time_start` bigint DEFAULT NULL COMMENT '开始时间',
  `u_time_end` bigint DEFAULT NULL COMMENT '结束时间',
  `u_token` int DEFAULT NULL COMMENT '是否登录',
  `u_nick_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`u_id`),
...
INSERT INTO `sys_user` VALUES ('10', 'jay', '2112006', '$2a$10$s2aEwRqzseGVyhFcnhCIxOAGVNAz9JWONOb9d/pcRMOdI./FM1wZq', '1542568656', '/2325//2102/', '/001//2//3/', '23365455', '1623534', '1', '/2102.5//2325.5/');
INSERT INTO `sys_user` VALUES ('15', 'jj', '2102001', '$2a$10$s2aEwRqzseGVyhFcnhCIxOAGVNAz9JWONOb9d/pcRMOdI./FM1wZq', '1542568656', '/2325//2203/', '/2//3/', '23365455', '1623534', '1', '/2325.6/');
